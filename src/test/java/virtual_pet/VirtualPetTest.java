...
public class VirtualPetTest {
    ...
    VirtualPet underTest = new RoboticDog("pluto", 4, 5, 5, 5, 5);
        underTest.feed();
    ...
    public void plutoDrinkingWater() {
        VirtualPet underTest = new RoboticDog("pluto", 7, 3, 8, 4, 5);
        underTest.water();
    ...
    public void plutoPlaying() {
        VirtualPet underTest = new RoboticDog("pluto", 2, 2, 5, 7, 5);
        underTest.play();
